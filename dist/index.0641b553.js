    ...
    configureFormListener() {
        this.searchForm.addEventListener('submit', (event)=>{
            ...
            fetch(`http://localhost:3000/?search=${search}&location=${location}&country=${this.countryCode}`).then((response)=>response.json()
                ...
                this.stopLoading();
                return results.map((job)=>_templates.jobTemplate(job, this.currencySymbol)
                ).join('');
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6IXwR","bNKaB"], "bNKaB", "parcelRequirec720")
